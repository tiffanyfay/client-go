...
// NewStoreWithPolicy creates and returns a ExpirationCache for a given policy
func NewStoreWithPolicy(keyFunc KeyFunc, ttl time.Duration, expirationPolicy ExpirationPolicy) Store {
	return &ExpirationCache{
		cacheStorage:     NewThreadSafeStore(Indexers{}, Indices{}),
		keyFunc:          keyFunc,
		clock:            clock.RealClock{},
